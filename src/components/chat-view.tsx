            ...
            <div className="relative pt-4">
              <div className="absolute -top-5 inset-x-0 z-0">
                <button
                  ...
                  className="w-full rounded-t-xl rounded-b-none border border-border border-b-0 bg-card/95 px-4 py-2 text-left shadow-lg backdrop-blur transition-colors hover:border-foreground/20 hover:bg-card"
                >
